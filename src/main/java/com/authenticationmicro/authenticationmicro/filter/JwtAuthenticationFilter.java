 ...
 * validates it, and populates the SecurityContext when the token is valid.
 */
@Component
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            // Invalid token — leave the SecurityContext empty; the request will be rejected downstream
